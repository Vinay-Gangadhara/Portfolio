    ...
    return (
        <nav className="fixed top-0 left-0 w-full z-30 bg-bgDark">
            ...
            >
                ...
                >
                    {/* for mobile view */}
                    <span className="sm:hidden">@Vinay</span>
                    {/* for web view */}
                    <span className="hidden sm:block">@Vinay Gangadhara</span>
                </ScrollLink>
                        ...
                        >
                            <div className="flex flex-col md:hidden bg-bgDark relative p-10">
                                ...
                                <div className="flex gap-4 p-6 border-b-white border-b-2 text-[22px]">
                                    <a
                                        href="https://www.linkedin.com/in/vinaygangadhara/"
                                        target="_blank"
                                    ...
                                    <a
                                        href="https://github.com/Vinay-Gangadhara"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    >
                                        <BsGithub />
                                    </a>
                                    <a href="mailto:vinaygangadhar02@gmail.com">
                                        <HiMailOpen />
                                    </a>
                                </div>
